    ...
    if(refresh_token && tokensExpired){
        ...
        try{
            ...
            if(response.ok){
                ...
                else if(data.redirect_uri){//something went wrong refreshing with spotify, controlled redirect
                    window.location.href = data.redirect_uri
                }
                else{//something unforeseen went wrong
...
async function onTokenExchange(){//when page loads get all credentials; also load playlists
    const access_token = localStorage.getItem("access_token");
    const tokensExpired = tokenTimeValidity()
