  ...
  return (
    <div className="footerContainer">
      <p className="footerText">
        Built by Bryan Fraschetti. &#169; Copyright 2024
      </p>
      <div className="socials">
        <a
          href="https://www.linkedin.com/in/bryan-fraschetti/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://github.com/bryanfraschetti"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://instagram.com/bryanfraschetti"
          target="_blank"
          rel="noreferrer"
        >
